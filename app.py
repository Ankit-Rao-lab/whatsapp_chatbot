...
def sms():
    ...
    if 'good morning' in incoming_msg:
        ...
        msg.body('Mr. Ankit Rao')

    elif "who are you" in incoming_msg:
        #! Telling who am I
        msg.body('I am called Whatsapp Bot made by Ankit Rao')
        ...
        url = 'http://newsapi.org/v2/top-headlines?country=in&apiKey=0da7128b51b645039ff6c507925f8ed7'
        r = requests.get(url)
        rj = r.json()
        try:
